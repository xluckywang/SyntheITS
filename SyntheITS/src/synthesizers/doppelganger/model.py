...
from synthesizers.doppelganger.network import DoppelGANgerGenerator, AttrDiscriminator, Discriminator
from synthesizers.doppelganger.doppelganger import DoppelGANgerNetwork

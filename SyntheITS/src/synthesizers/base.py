...
from preprocessing.timeseries_processor import (
    TimeSeriesDataProcessor, TimeSeriesModels)
from preprocessing.doppelganger_processor import DoppelGANgerProcessor
...
TrainParameters = namedtuple('TrainParameters', _train_parameters,
                             defaults=('', None, 300, 50, None, 10, 0.005, True, None, 1, 1))
...
class BaseGANModel(BaseModel):
    ...
    def fit(self,
        ...
        Returns:
            Fitted synthesizer
        """
        if self.__MODEL__ in TimeSeriesModels.__members__:

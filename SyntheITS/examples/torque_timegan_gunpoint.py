...
# 指定日志保存文件夹路径
output_directory = '../data_sets_12_24/validation_data/gunpoint_oldversusyoung_data/generate'
...
train_args = TrainParameters(epochs=1000, sequence_length=6, number_sequences=150)

# 3. 读取数据
read_data_path = '../data_sets_12_24/validation_data/gunpoint_oldversusyoung_data/original/not_ok_data.csv'
save_data_path = '../data_sets_12_24/validation_data/gunpoint_oldversusyoung_data/generate/not_ok_data_syn.csv'
...
# 4. 处理模型保存路径
model_save_path = 'timegan_models/synthesizer_gunpoint_not_ok_1000.pkl'
...
# 9. 逆向归一化并保留八位小数
synth_data_original = np.round(scaler.inverse_transform(synth_data_reshaped), 10)

...
# 指定日志保存文件夹路径
# output_directory = '../data_sets_12_24/validation_data/chinatown_data_02/generate'
output_directory = '../data_sets_12_24/validation_data/chinatown_data/generate/timegan_test'
...
train_args = TrainParameters(epochs=1000, sequence_length=6, number_sequences=24)

# 3. 读取数据
# read_data_path = '../data_sets_12_24/validation_data/chinatown_data_02/original/not_ok_data.csv'
# save_data_path = '../data_sets_12_24/validation_data/chinatown_data_02/generate/not_ok_data_syn.csv'
read_data_path = '../data_sets_12_24/validation_data/chinatown_data/original/not_ok_data.csv'
save_data_path = '../data_sets_12_24/validation_data/chinatown_data/generate/timegan_test/not_ok_data_syn.csv'
...
# 4. 处理模型保存路径
# model_save_path = '../data_sets_12_24/validation_data/chinatown_data_02/generate/synthesizer_chinatown_not_ok_1000.pkl'
model_save_path = '../data_sets_12_24/validation_data/chinatown_data/generate/timegan_test' \
                  '/synthesizer_chinatown_not_ok_1000.pkl'
...
# 9. 逆向归一化并保留八位小数
synth_data_original = np.round(scaler.inverse_transform(synth_data_reshaped))

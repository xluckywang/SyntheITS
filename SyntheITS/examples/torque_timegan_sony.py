...
# 指定日志保存文件夹路径
output_directory = '../data_sets_12_24/validation_data/sony_ai_robot_data/generate'
...
train_args = TrainParameters(epochs=1000, sequence_length=6, number_sequences=70)

# 3. 读取数据
read_data_path = '../data_sets_12_24/validation_data/sony_ai_robot_data/original/ok_data.csv'
save_data_path = '../data_sets_12_24/validation_data/sony_ai_robot_data/generate/timegan/ok_data_syn.csv'
...
# 4. 处理模型保存路径
model_save_path = '../save_synthesizer_models/timegan/sony_ai_robot_data/synthesizer_sony_ok_1000.pkl'

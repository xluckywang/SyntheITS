...
# 文件路径配置
file_path = "../data_sets_12_24/validation_data/chinatown_data/original/ok_data.csv"
output_directory = '../data_sets_12_24/validation_data/chinatown_data/generate/timediffusion_test'

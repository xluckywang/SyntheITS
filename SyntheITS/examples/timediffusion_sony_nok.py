...
# 文件路径配置
file_path = "../data_sets_12_24/validation_data/sony_ai_robot_data/original/not_ok_data.csv"
output_directory = '../data_sets_12_24/validation_data/sony_ai_robot_data/generate/timediffusion_0.99'
...
synthetic_df = synthetic_df.round(8)
# 将舍入后的列转换回整数类型

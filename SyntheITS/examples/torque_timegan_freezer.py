...
# 指定日志保存文件夹路径
output_directory = '../data_sets_12_24/validation_data/freezer_small_train_data/generate'
...
train_args = TrainParameters(epochs=1000, sequence_length=6, number_sequences=301)

# 3. 读取数据
read_data_path = '../data_sets_12_24/validation_data/freezer_small_train_data/original/ok_data.csv'
save_data_path = '../data_sets_12_24/validation_data/freezer_small_train_data/generate/ok_data_syn.csv'
...
# 4. 处理模型保存路径
model_save_path = 'timegan_models/synthesizer_freezer_ok_1000.pkl'

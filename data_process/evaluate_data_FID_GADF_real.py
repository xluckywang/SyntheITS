...
if __name__ == '__main__':
    ...
    if data_ype == "tightening_data":
        ...
        save_dir_real = f'data_sets_12_24_/tightening_data/original/{data_class}'  # 修改为实际的文件夹路径
        save_dir_generated = f'data_sets_12_24_/tightening_data/generate/{model_type}/{data_class}'  # 修改为实际的文件夹路径
    ...
    # 2、验证数据
        ...
        save_dir_real = f'data_sets_05_15/tightening_data/original/{data_class}'  # 修改为实际的文件夹路径
        save_dir_generated = f'data_sets_05_15/tightening_data/generate/{model_type}/{data_class}'  # 修改为实际的文件夹路径

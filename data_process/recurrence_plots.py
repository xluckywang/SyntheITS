...
# 文件路径作为参数传递
# file_path = os.path.join("", "tightening_data", "generate", "data_ok", "shuffled_curves.csv")
# file_path = os.path.join("", "tightening_data", "generate", "data_nok", "shuffled_curves.csv")
# file_path = os.path.join("", "tightening_data", "generate", "timegan", "tightening_data_nor_syn.csv")  # timegan模型生成的拧紧数据
file_path = 'data_sets_01_15/tightening_data/generate/doppelganger/ok_data_syn.csv'
#
# file_path = os.path.join("", "tightening_data", "original", "data_ok", "tightening_data_nor.csv")
# file_path = os.path.join("", "tightening_data", "original", "data_nok", "tightening_data_abn.csv")

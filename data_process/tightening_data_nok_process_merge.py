...
for h_file_01 in h_files:
    ...
    for h_file_02 in h_files_01:
        target_directory_02 = Path(h_file_02) / "C_NOK*.csv"
...
shuffled_data_rounded = shuffled_data.round(3)  # 或者使用 shuffled_data.astype(float).round(3)
shuffled_data_rounded.to_csv(target_directory / 'tightening_data_nok.csv', index=False)

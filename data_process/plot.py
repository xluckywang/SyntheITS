...
# 原始数据
# data = pd.read_csv('data_sets_12_24/tightening_data/original/ok_data.csv')
data = pd.read_csv('data_sets_12_24/tightening_data/generate/doppelganger/not_ok_data_syn.csv')

# 生成数据
# data = pd.read_csv('data_sets_12_24/tightening_data/generate/timegan/not_ok_data_syn.csv')
...
# 设置横坐标刻度间隔为50
plt.xticks(range(0, len(data[column]), 50))

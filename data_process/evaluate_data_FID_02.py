...
# 读取CSV文件
real_data = pd.read_csv('data_sets_12_24/validation_data/chinatown_data/original/ok_data.csv')
generated_data = pd.read_csv('data_sets_12_24/validation_data/chinatown_data/generate/ok_data_syn.csv')

...
class My_RESNET_LSTM:
    ...
    def build_model(self, input_shape, nb_classes, n_feature_maps):
        ...
        # LSTM Layers
        lstm_layer1 = tf.keras.layers.LSTM(n_feature_maps, return_sequences=True)(output_block_3)
        # lstm_layer2 = tf.keras.layers.LSTM(32)(lstm_layer1)

        # # Add an extra dimension to lstm_layer2
        # lstm_layer2_expanded = tf.expand_dims(lstm_layer2, axis=1)

        # FINAL
        gap_layer = tf.keras.layers.GlobalAveragePooling1D()(lstm_layer1)

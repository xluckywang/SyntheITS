...
def main():
    ...
    for RATIO in RATIOS:
        ...
        def build_resnet1d_model(input_shape, num_blocks=2, filters=64, kernel_size=3, lstm_units=64, dropout_rate=0.2, num_heads=8):
            ...
            attention = MultiHeadAttention(num_heads=num_heads, key_dim=lstm_units // num_heads)(x, x)

...
def main():
    ...
    for RATIO in RATIOS:
        ...
        save_path = f"experimental_results/validation_data/{DATA_TYPE}/{MODEL_TYPE}/experiment_{RATIO:.2f}/model_lstm"
        ...
        metrics_list_all = [evaluate_model(loaded_model, X_test_folds[i], Y_test_folds[i]) for i in range(len(X_test_folds))]

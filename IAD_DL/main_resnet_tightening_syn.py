...
def main():
    ...
    MODEL_TYPE = "timegan_and_timediffusion"
    RATIO = 1.00
    output_directory = f'experimental_results/{DATA_TYPE}/{MODEL_TYPE}/experiment_syn_{RATIO:.2f}/exp_output/'
    ...
    save_path = f"experimental_results/{DATA_TYPE}/{MODEL_TYPE}/experiment_syn_{RATIO:.2f}/model_resnet"

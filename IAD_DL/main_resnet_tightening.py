...
def main():
    ...
    MODEL_TYPE = "timegan"
    RATIO = 0.00
    output_directory = f'experimental_results_01_19/{DATA_TYPE}/{MODEL_TYPE}/experiment_{RATIO:.2f}/exp_output/'

    # 2. 设置样本数据的基本路径、路径字典
    base_path_ori = os.path.join("data_sets_01_19", DATA_TYPE, "sample_separate")
    base_path_syn = os.path.join("data_sets_01_19", DATA_TYPE, "generate", MODEL_TYPE)
    ...
    save_path = f"experimental_results_01_19/{DATA_TYPE}/{MODEL_TYPE}/experiment_{RATIO:.2f}/model_resnet"
